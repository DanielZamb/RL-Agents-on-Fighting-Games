...
def main():
    ...
    #     results = agent.train()
    #     if idx % 1000==0:
    #         checkpoint = agent.save(r"C:\Users\JUAN\Documents\Zambrano\RL-Agents-on-Fighting-Games\THESIS_AGENTS\A3C AGENTS\PARALLEL\saved_checkpoints")
    ...
    checkpoint = r"C:\Users\JUAN\Documents\Zambrano\RL-Agents-on-Fighting-Games\THESIS_AGENTS\A3C AGENTS\PARALLEL\saved_checkpoints\checkpoint_008001"
